...
Additionally, some objects feature elements that are recoloured either by a random company colour or the player's company colour (see Parameters).
...
-> Use only the player's company colour to recolour objects
                           = Several buildings in this set have elements that are, by default, recoloured using a random company colour.{}By turning on this parameter, you can choose to use only the player's company colour.
...
1. "Polish Building Set 0.1" by TadeuszD, licensed under GPL v2.
2. "Polish Buildings Set 1.4.0" by Sojita, licensed under CC-BY-SA v3.0.
